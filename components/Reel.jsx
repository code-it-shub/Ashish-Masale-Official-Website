...
const Reel = () => {
  ...
  return (
    <div className="reel lg:h-[797px] w-screen flex md:bg-contain md:h-[700px] h-[988px]">
    <div className="left lg:w-[50%] md:w-[60%] lg:md:h-[90%] h-[40%] flex flex-col justify-center items-end text-gray-800 ">
      <small
        className="lg:text-[48px] font-bold lg:w-[75%] md:w-[75%] leading-12 md:text-[32px] mb-4 w-auto text-[24px] lg:md:text-left text-center lg:pt-0 pt-[170px] md:pt-0"
        data-aos="fade-up"
      >
      ...
      <small className="lg:w-[75%] lg:text-[32px] md:text-[20px] md:w-[75%] w-auto text-[16px]" data-aos="fade-up">
        <p className="md:text-start">Delicious Recipes with Ashish Masala</p>
      </small>
    </div>
